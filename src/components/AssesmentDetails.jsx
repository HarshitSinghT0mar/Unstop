...
const AssesmentDetails = () => {
  return (
    ...
    <img style={{position:"absolute" ,right:"16px",top:"16px"}} src='/assets/3 dot.svg'/> 
    {/*have already set maths-assesment postion to relative*/}
          ...
          <div className="maths-footer">
            <div className="ques-duration">
              <div><p>00</p><p>Duration</p></div>
              <div><p>00</p><p>Questions</p></div>
            
            </div>
            <div className="share-user">
                <div className="share-image"><img src="/assets/link.svg"/>Share</div>
